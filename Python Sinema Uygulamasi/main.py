...
def uygulamaSayfa():
    ...
    def filmEklePage():
        ...
        def ekleme_basarili():
            if filmAdi.get()!= "" and filmTur_combobox.get()!= "Türü" and filmdurum_combobox.get()!= "Durum" and filmpuan_combobox.get()!="Puan":
                ad = filmAdi.get()
                tur=filmTur_combobox.get()
                durum = filmdurum_combobox.get()
                puan = int(filmpuan_combobox.get())
                note = filmdegerlendirme_textbox.get("1.0","end").strip()
                film["ad"] = ad
                film["tur"] = tur
                film["durum"] = durum
                film["puan"] = puan
                ...
                messagebox.showerror("Hata","Lütfen gereken tüm değerleri seçiniz")
